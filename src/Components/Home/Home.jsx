...
const Home = () => {
    ...
    return (
        <div>
            ...
            <div>
                <h1 className='text-center text-3xl font-bold p-6'>Our <span className="text-pink-600">Services</span></h1>
            </div>
            ...
            <div>
                <div className='min-h-[40vh] bg-base-200 mb-10 pt-10 pl-10'>
